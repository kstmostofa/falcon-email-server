...
import { Task } from '@/pages/task/columns';
import { router } from '@inertiajs/react';
import { LoaderCircle, Play, Trash } from 'lucide-react';
import { useState } from 'react';

export default function TaskTableAction({ task, setRefresh }: { task: Task; setRefresh: React.Dispatch<React.SetStateAction<boolean>> }) {
    ...
    const handleDelete = () => {
        setDeleting(true);
        router.delete(route('smtp.destroy', task.id), {
            preserveScroll: true,
            preserveState: true,
            onFinish: () => {
                setDeleting(false);
